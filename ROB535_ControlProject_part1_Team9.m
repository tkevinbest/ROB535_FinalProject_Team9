function [sol_1, FLAG_terminate] = ROB535_ControlProject_part1_Team9(TestTrack, Xobs_seen, curr_state)
...
%276 point array)
sec_per_point = 1.4/interp_scale; %SPEED KNOB
