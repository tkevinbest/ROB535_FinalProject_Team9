...
%Get idx_start and end
idx_start = 2;
idx_end = length(center_line);

%Get new path
target_path = avoidObstacles(center_line, Xobs,idx_start,idx_end,TestTrack);


%Plot path and heading
% heading_x = cos(target_path(:,3));
% heading_y = sin(target_path(:,3));
% quiver(target_path(:,1),target_path(:,2),heading_x,heading_y)
% i=6;
